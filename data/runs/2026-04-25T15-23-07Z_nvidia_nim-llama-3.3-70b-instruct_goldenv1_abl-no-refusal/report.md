# Run report — `2026-04-25T15-23-07Z_nvidia_nim-llama-3.3-70b-instruct_goldenv1_abl-no-refusal`

**Pass rate: `93.3%`** (28 / 30 examples passed every metric threshold).
...
| git_branch | `main` |
| python | `3.14.4` |
| started_at_utc | `2026-04-25T15:33:19Z` |
| finished_at_utc | `2026-04-25T15:33:19Z` |
