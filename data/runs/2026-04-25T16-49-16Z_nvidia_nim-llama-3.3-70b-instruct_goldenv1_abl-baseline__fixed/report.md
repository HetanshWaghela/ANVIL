# Run report — `2026-04-25T16-49-16Z_nvidia_nim-llama-3.3-70b-instruct_goldenv1_abl-baseline__fixed`

**Pass rate: `100.0%`** (10 / 10 examples passed every metric threshold).
...
| git_branch | `main` |
| python | `3.14.4` |
| started_at_utc | `2026-04-25T16:52:25Z` |
| finished_at_utc | `2026-04-25T16:52:25Z` |

## Aggregate metrics

| metric | mean | threshold (per-example) | per-example pass |
| :--- | ---: | ---: | :---: |
| `refusal_calibration` | 1.000 | 1.000 | 10/10 |
| `retrieval_precision_at_k` | 0.520 | 0.240 | 10/10 |
| `retrieval_recall_at_k` | 1.000 | 0.990 | 10/10 |
| `faithfulness` | 1.000 | 0.800 | 10/10 |
| `citation_accuracy` | 1.000 | 0.800 | 10/10 |
| `entity_grounding` | 1.000 | 0.900 | 10/10 |
| `structural_completeness` | 1.000 | 1.000 | 10/10 |
| `calculation_correctness` | 1.000 | 1.000 | 10/10 |
