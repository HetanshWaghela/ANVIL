# Run report — `2026-04-25T18-24-28Z_fake_goldenv2-public100_abl-baseline`

**Pass rate: `100.0%`** (100 / 100 examples passed every metric threshold).
...
| git_branch | `main` |
| python | `3.14.4` |
| started_at_utc | `2026-04-25T18:24:29Z` |
| finished_at_utc | `2026-04-25T18:24:29Z` |

## Aggregate metrics

| metric | mean | threshold (per-example) | per-example pass |
| :--- | ---: | ---: | :---: |
| `refusal_calibration` | 1.000 | 1.000 | 100/100 |
| `retrieval_precision_at_k` | 0.385 | 0.240 | 88/88 |
| `retrieval_recall_at_k` | 1.000 | 0.990 | 88/88 |
| `faithfulness` | 1.000 | 0.800 | 88/88 |
