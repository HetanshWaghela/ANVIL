# Run report — `2026-04-25T15-33-42Z_nvidia_nim-llama-3.3-70b-instruct_goldenv1_abl-no-citation-enforcer`
...
| git_branch | `main` |
| python | `3.14.4` |
| started_at_utc | `2026-04-25T15:37:58Z` |
| finished_at_utc | `2026-04-25T15:37:58Z` |

## Aggregate metrics

| metric | mean | threshold (per-example) | per-example pass |
| :--- | ---: | ---: | :---: |
| `refusal_calibration` | 0.900 | 1.000 | 27/30 |
| `retrieval_precision_at_k` | 0.388 | 0.240 | 25/25 |
| `retrieval_recall_at_k` | 0.987 | 0.990 | 24/25 |
| `faithfulness` | 0.880 | 0.800 | 22/25 |
