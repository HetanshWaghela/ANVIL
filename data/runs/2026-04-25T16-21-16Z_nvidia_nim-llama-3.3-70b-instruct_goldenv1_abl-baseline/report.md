# Run report — `2026-04-25T16-21-16Z_nvidia_nim-llama-3.3-70b-instruct_goldenv1_abl-baseline`
...
| git_branch | `main` |
| python | `3.14.4` |
| started_at_utc | `2026-04-25T16:23:04Z` |
| finished_at_utc | `2026-04-25T16:23:04Z` |

## Aggregate metrics

| metric | mean | threshold (per-example) | per-example pass |
| :--- | ---: | ---: | :---: |
| `refusal_calibration` | 0.600 | 1.000 | 18/30 |
| `retrieval_precision_at_k` | 0.388 | 0.240 | 25/25 |
| `retrieval_recall_at_k` | 0.987 | 0.990 | 24/25 |
| `faithfulness` | 0.520 | 0.800 | 13/25 |
| `citation_accuracy` | 0.980 | 0.800 | 24/25 |
| `entity_grounding` | 1.000 | 0.900 | 25/25 |
| `structural_completeness` | 0.987 | 1.000 | 24/25 |
| `calculation_correctness` | 0.750 | 1.000 | 9/12 |
