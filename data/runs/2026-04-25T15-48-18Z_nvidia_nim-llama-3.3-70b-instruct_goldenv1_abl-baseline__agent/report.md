# Run report — `2026-04-25T15-48-18Z_nvidia_nim-llama-3.3-70b-instruct_goldenv1_abl-baseline__agent`

**Pass rate: `0.0%`** (0 / 3 examples passed every metric threshold).
...
| git_branch | `main` |
| python | `3.14.4` |
| started_at_utc | `2026-04-25T15:52:49Z` |
| finished_at_utc | `2026-04-25T15:52:49Z` |

## Aggregate metrics

| metric | mean | threshold (per-example) | per-example pass |
| :--- | ---: | ---: | :---: |
| `refusal_calibration` | 0.000 | 1.000 | 0/3 |
| `retrieval_precision_at_k` | 0.000 | — | 0/3 |
| `retrieval_recall_at_k` | 0.000 | 0.990 | 0/3 |
| `faithfulness` | 0.000 | 0.800 | 0/3 |
| `citation_accuracy` | 1.000 | 0.800 | 3/3 |
| `entity_grounding` | 1.000 | 1.000 | 3/3 |
| `structural_completeness` | 0.000 | 1.000 | 0/3 |
| `calculation_correctness` | 0.000 | 1.000 | 0/3 |
