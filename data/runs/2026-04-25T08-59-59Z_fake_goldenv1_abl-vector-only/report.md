# Run report — `2026-04-25T08-59-59Z_fake_goldenv1_abl-vector-only`

**Pass rate: `90.0%`** (27 / 30 examples passed every metric threshold).
...
| ablation_config.name | `vector-only` |
| ablation_config.retrieval_mode | `vector_only` |
...
| `retrieval_precision_at_k` | 0.332 | 0.240 | 25/25 |
| `retrieval_recall_at_k` | 0.987 | 0.990 | 24/25 |
| `faithfulness` | 1.000 | 0.800 | 25/25 |
| `citation_accuracy` | 0.980 | 0.800 | 23/25 |
